...
class Calcalator {
    ...
    delete() {
        var _a;
        this.currOperand.textContent = (_a = this.currOperand.textContent) === null || _a === void 0 ? void 0 : _a.substring(0, this.currOperand.textContent.length - 1);
    } /*  end delete()    */
    // === dot =========================================================
    dot() {
        var _a;
        ...
        if (this.dotPresent === false) {
            ...
            if (((_a = this.currOperand.textContent) === null || _a === void 0 ? void 0 : _a.search('.')) === -1) {
    ...
    display(newNumText) {
        ...
        if (this.eqPushed === true) {
            ...
            let subText = (_a = this.currOperand.textContent) === null || _a === void 0 ? void 0 : _a.split('.');
            if ((subText === null || subText === void 0 ? void 0 : subText.length) !== 1) {
                ...
                this.currNum = Number((_b = this.currOperand.textContent) === null || _b === void 0 ? void 0 : _b.replace(/,/g, ''));
...
dot === null || dot === void 0 ? void 0 : dot.addEventListener('click', () => calc.dot());
equal === null || equal === void 0 ? void 0 : equal.addEventListener('click', () => calc.equal());
clr === null || clr === void 0 ? void 0 : clr.addEventListener('click', () => calc.clear());
del === null || del === void 0 ? void 0 : del.addEventListener('click', () => calc.delete());
